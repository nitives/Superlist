...
$player_primary_color = "7463d4"; // primary color for loader and buttons
$player_secondary_color = "1d154c"; // secondary color for hovers and elements
